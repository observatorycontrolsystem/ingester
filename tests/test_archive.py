...
from ocs_ingester.archive import PostProcService
...
class TestArchiveService(unittest.TestCase):
    ...
    def test_archive_post(self, post_mock, get_mock):
        archive_service = ArchiveService(api_root='http://fake/', auth_token='', broker_url='')
    ...
    def test_existing_md5(self, post_mock, get_mock):
        archive_service = ArchiveService(api_root='http://return1/', auth_token='', broker_url='')
    ...
    def test_bad_connection(self, post_mock, get_mock):
        archive_service = ArchiveService(api_root='http://badconnection/', auth_token='', broker_url='')
